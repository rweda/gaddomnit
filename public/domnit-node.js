...
var util$4 = util;
var inherits$1 = util$4.inherits;
var notEnumerableProp$1 = util$4.notEnumerableProp;
...
var _finally = function(Promise, tryConvertToPromise) {
var util$$1 = util;
...
var PassThroughHandlerContext =
    _finally(Promise, tryConvertToPromise);
        ...
        for (i = 0; i < len - 1; ++i) {
            ...
            if (util$$1.isObject(item)) {
                ...
                return apiRejection("expecting an object but got " +
                    "A catch statement predicate " + util$$1.classString(item));
            }
        }
...
var Promise$2;
var bind$2 = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
var indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

DefaultStyle = DefaultStyle_1;

Promise$2 = bluebird_1;
...
ElementSerializer$1 = (function() {
  ...
  function ElementSerializer(el, children, opt, isRoot) {
    ...
    this.opt = opt;
    this.isRoot = isRoot;
    this.saveStyle = bind$2(this.saveStyle, this);
  ...
  ElementSerializer.prototype.defaultStyleFilter = function() {
    if (!this.opt.useBrowserStyle) {
      return Promise$2.resolve(function() {
        return false;
      });
    }
    return DefaultStyle.get(this.el.tagName).then((function(_this) {
      return function(def) {
        return Promise$2.resolve(function(style, prop) {
  ...
  ElementSerializer.prototype.toString = function() {
    return Promise$2.resolve(this.update()).then((function(_this) {
      return function() {
        var attrs, name;
...
Domnit = (function() {
  ...
  Domnit.prototype.serialize = function(el, root) {
    ...
    return Promise$1.all([]).then((function(_this) {
      return function() {
        if (_this.opt.nonBlocking) {
          return Promise$1.delay(0);
        }
      };
    })(this)).then((function(_this) {
      return function() {
        return Promise$1.map(el.children, (function(child) {
